...
<body <?php body_class(); ?>>
	...
	<img alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" src="<?php echo of_get_option( 'esteem_header_logo_image', '' ); ?>">
						...
						<?php } if( of_get_option( 'esteem_show_header_logo_text', 'text_only' ) == 'both' || of_get_option( 'esteem_show_header_logo_text', 'text_only' ) == 'text_only' ) {
						?>
					...
					<div class="header-button">
                     <div class="header-learn-more">
                     	<a href="http://localhost/youthfuusa/index.php/connect-2/"><input type="button" name="button" value="LEARN MORE"></a>
                     </div>
                     <div class="header-apply-now">
                     	<input type="button" name="button" value="APPLY NOW">
                     	<div>
                     		<a>New to YFU? Create an acccount and apply!</a>
                     		<p>Thank you for your interest in YFU.To begin your YFU experience create ab a/c below</p>
                     		<a>Forgot My Password/Username </a>
                     		<p></p>
                     	</div>
                     </div>
					</div>
