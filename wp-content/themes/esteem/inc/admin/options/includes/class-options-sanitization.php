...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'esteem' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'esteem' ),
		'repeat-y'  => __( 'Repeat Vertically', 'esteem' ),
		'repeat'    => __( 'Repeat All', 'esteem' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'esteem' ),
		'top center'    => __( 'Top Center', 'esteem' ),
		'top right'     => __( 'Top Right', 'esteem' ),
		'center left'   => __( 'Middle Left', 'esteem' ),
		'center center' => __( 'Middle Center', 'esteem' ),
		'center right'  => __( 'Middle Right', 'esteem' ),
		'bottom left'   => __( 'Bottom Left', 'esteem' ),
		'bottom center' => __( 'Bottom Center', 'esteem' ),
		'bottom right'  => __( 'Bottom Right', 'esteem')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'esteem' ),
		'fixed'  => __( 'Fixed in Place', 'esteem')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'esteem' ),
		'italic'      => __( 'Italic', 'esteem' ),
		'bold'        => __( 'Bold', 'esteem' ),
		'bold italic' => __( 'Bold Italic', 'esteem' )
		);
